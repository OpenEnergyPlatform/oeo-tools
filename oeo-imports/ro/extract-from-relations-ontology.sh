...
robot remove --input ../../ontology/imports/ro-extracted.owl --term BFO:0000051 --select "self" --axioms annotation --signature true --preserve-structure false --output ../../ontology/imports/ro-extracted.owl
