...
robot merge --input ${tmpdir}/meno-extracted-w-hierarchy.owl --input ${tmpdir}/meno-extracted-n-hierarchy.owl annotate --ontology-iri https://openenergyplatform.org/ontology/oeo/imports/meno-extracted.owl --version-iri https://openenergyplatform.org/ontology/oeo/dev/imports/meno-extracted.owl --output ${tmpdir}/meno-extracted.owl
