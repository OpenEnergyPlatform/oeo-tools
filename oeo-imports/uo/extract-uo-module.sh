...
robot merge --input uo-full-download.owl extract --method MIREOT --lower-terms uo-w-hierarchy.txt --intermediates all --output uo-extracted.owl
## add xmlns:obo="http://purl.obolibrary.org/obo/"
#sed -i 's/xmlns:owl/xmlns:obo="http:\/\/purl.obolibrary.org\/obo\/"\xmlns:owl/' uo-module-temp.owl
