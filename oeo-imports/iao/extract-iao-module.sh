...
robot merge --input ${tmpdir}/iao-extracted-w-hierarchy.owl --input ${tmpdir}/iao-extracted-n-hierarchy.owl annotate --ontology-iri https://openenergyplatform.org/ontology/oeo/imports/iao-extracted.owl --version-iri https://openenergyplatform.org/ontology/oeo/dev/imports/iao-extracted.owl --output ${tmpdir}/iao-extracted.owl
...
#robot annotate --input iao-extracted.owl  --ontology-iri https://openenergyplatform.org/ontology/oeo/imports/iao-extracted.owl --version-iri https://openenergyplatform.org/ontology/oeo/dev/imports/iao-extracted.owl --output iao-extracted.owl
